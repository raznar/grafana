...
func (hs *HTTPServer) registerRoutes() {
	...
	r.Get("/admin/labs", authorize(ac.EvalPermission(ac.ActionFeatureManagementWrite)), hs.Index)
	...
	r.Group("/api/admin", func(adminRoute routing.RouteRegister) {
		...
		adminRoute.Get("/feature-toggles", authorize(ac.EvalAny(ac.EvalPermission(ac.ActionFeatureManagementRead), ac.EvalPermission(ac.ActionFeatureManagementWrite))), routing.Wrap(hs.AdminGetFeatureToggles))
