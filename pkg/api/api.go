...
func (hs *HTTPServer) registerRoutes() {
	...
	r.Group("/api/admin", func(adminRoute routing.RouteRegister) {
		...
		adminRoute.Get("/labs", reqGrafanaAdmin, routing.Wrap(hs.AdminGetLabsFeatureToggles))
		adminRoute.Put("/labs/:flag", reqGrafanaAdmin, routing.Wrap(hs.AdminUpdateLabsFeatureToggle))
